...
fn main() -> ! {
    ...
    let mut task_timer = Timer::new(dwm1001.TIMER1);
    let mut timeout_timer = Timer::new(dwm1001.TIMER0);
    ...
    defmt::info!("starting transmission mode");
